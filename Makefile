# $Id: Makefile,v 1.45 2006-11-15 09:26:44 turbo Exp $
...
uBINARIES	= df_afs.pl list_afs_vols.sh idn.sh build-latest-spamassassin.sh cvs-rsh create_htmls.pl create_thumbs.pl renumber.pl urldecode
